...
import { View, StyleSheet, Dimensions, TouchableWithoutFeedback, PanResponder, Image, ImageSourcePropType } from 'react-native';
import { MaterialIcons } from '@expo/vector-icons';
import { Svg, Circle, Line, Text as SvgText, Rect, G } from 'react-native-svg';
import { config } from '../../src/config';
import { usePhotoAnnotation, Annotation, COLORS } from '../../hooks/usePhotoAnnotation';
  ...
  const panResponder = useRef(
    PanResponder.create({
      ...
      onPanResponderMove: (evt) => {
        ...
        setCurrentDrawing((prev) => prev ? { ...prev, endX, endY } : null);
      },
