...
// This file acts as the ProjectsList screen when the stack is at the root of the projects tab
// In Expo Router, this would be: app/(tabs)/projects/index.tsx
  ...
  return (
    <View style={styles.container}>
      <FlatList
        ...
        renderItem={({ item }) => (
          <Card style={styles.card} onPress={() => router.push(`/projects/${item.id}`)}>
