    ...
    <ScrollView style={styles.container}>
        ...
        <View style={styles.headerTop}>
          ...
          <View style={styles.headerActions}>
            <TouchableOpacity
              ...
              onPress={() => router.push(`/projects/edit?id=${project.id}`)}
            >
      ...
      <View style={styles.quickActions}>
        <Button
          ...
          onPress={() => router.push(`/projects/photo?projectId=${project.id}`)}
        />
        <Button
          title="Voice Note"
          icon="mic"
        ...
        <Button
          ...
          size="small"
          style={styles.quickActionButton}
          onPress={() => router.push(`/projects/estimate/new?projectId=${project.id}`)}
        />
      </View>
    </ScrollView>
  );
