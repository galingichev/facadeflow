...
const translations: Record<AppLanguage, Record<string, string>> = {
  ...
  bg: {
    ...
    'Actual profit / margin': 'Реална печалба / марж',
    'Actual profit unavailable': 'Реалната печалба не е налична',
    'Projected profit': 'Прогнозна печалба',
    'Projected profit / margin': 'Прогнозна печалба / марж',
    'Projected Profit': 'Прогнозна печалба',
    ...
    'Projected margin': 'Прогнозен марж',
    ...
    'Contract value minus budgeted cost. Actual profit becomes available after expenses are recorded.': 'Договорната стойност минус бюджетните разходи. Реалната печалба става налична след записване на разходи.',
    'This project is still at quote stage, so profit is projected from the budget.': 'Проектът още е на етап оферта, затова печалбата е прогнозна според бюджета.',
    ...
    'Owner action: confirm glazing specification before issuing the formal quote.': 'Действие за собственика: потвърдете спецификацията на стъклопакета преди официалната оферта.',
    'Owner action: present projected margin and ask for quote approval before ordering profiles.': 'Действие за собственика: представете прогнозния марж и поискайте одобрение на офертата преди поръчка на профили.',
    'Owner action: confirm lift access and book the second-floor install slot.': 'Действие за собственика: потвърдете достъпа за вишка и резервирайте монтажа на втория етаж.',
    ...
    'Owner action: send final invoice and archive signed handover notes.': 'Действие за собственика: изпратете финалната фактура и архивирайте подписаните документи за предаване.',
  },
};
